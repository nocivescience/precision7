...
class initGame{
  constructor(){
    this.rightRandom= undefined;
    this.leftRandom= undefined;
  }
  rightMove(){
    this.rightRandom= Math.random()<0.5?true:false;
    return this.rightRandom;
  }
  leftMove(){
    this.leftRandom= Math.random()<0.5?true:false;
...
function main(timestamp) {
  ...
  balls.forEach((ball) => {
    ball.velocityX = Math.random()<.5?1:-1;
    ball.velocityY = Math.random()<.5?1:-1;
  });
